  ...
  EVM: {
    CDPEvmWallet: {
      env: {
        ...
        optional: ["RPC_URL", "AGENTKIT_WALLET_DATA"],
      },
    ...
    Viem: {
      env: {
        ...
        optional: ["CDP_API_KEY_ID", "CDP_API_KEY_SECRET", "RPC_URL", "AGENTKIT_WALLET_DATA"],
      },
    ...
    CDPSmartWallet: {
      env: {
        ...
        required: ["CDP_API_KEY_ID", "CDP_API_KEY_SECRET", "CDP_WALLET_SECRET"],
        optional: ["PAYMASTER_URL", "RPC_URL", "AGENTKIT_WALLET_DATA"],
      },
  ...
  CUSTOM_EVM: {
    Viem: {
      env: {
        ...
        required: ["PRIVATE_KEY"],
        optional: ["CDP_API_KEY_ID", "CDP_API_KEY_SECRET", "AGENTKIT_WALLET_DATA"],
      },
